...
#c.JupyterHub.data_files_path = '/Users/sitin/.virtualenv/uni-notebooks/share/jupyterhub'
...
c.Spawner.notebook_dir = os.path.join(os.environ['JUPYTER_CONFIG_DIR'], 'notebooks')
